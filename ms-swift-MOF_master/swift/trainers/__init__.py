...
if TYPE_CHECKING:
    ...
    from .trainers import Seq2SeqTrainer, Trainer, EmbeddingTrainer, RerankerTrainer, MultiTaskGenTrainer
    ...
    _import_structure = {
        ...
        'trainers': ['Seq2SeqTrainer', 'Trainer', 'EmbeddingTrainer', 'RerankerTrainer', 'MultiTaskGenTrainer'],
        'mixin': ['SwiftMixin'],
